...
{
	if (map->matrice[(int)(map->ray.posX - map->ray.planeX * map->moveSpeed)][(int)map->ray.posY] == '0')
		map->ray.posX -= map->ray.planeX * map->moveSpeed;
	if (map->matrice[(int)map->ray.posX][(int)(map->ray.posY - map->ray.planeY * map->moveSpeed)] == '0')
